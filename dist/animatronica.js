  ...
  require.define('/gif.coffee', function (module, exports, __dirname, __filename) {
    ...
    GIF = function (super$) {
      ...
      GIF.prototype.getContextData = function (ctx) {
        return ctx.getImageData(this.options.x, this.options.y, this.options.width, this.options.height).data;
      };
      GIF.prototype.getImageData = function (image) {
        var ctx;
        if (!(null != this._canvas)) {
          this._canvas = document.createElement('canvas');
          this._canvas.width = this.options.fullWidth;
          this._canvas.height = this.options.fullHeight;
        }
...
(function() {
  ...
  ImageExport = (function() {
    ...
    ImageExport.prototype.cropDimentions = function(dimentions) {
      return _.extend(dimentions, {
