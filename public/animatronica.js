...
(function() {
  ...
  Interpolation = (function() {
    ...
    Interpolation.prototype.interpolateBetween = function(first, last, frame) {
      return first.state + (last.state - first.state) * (frame - first.frame) / (last.frame - first.frame);
    };
...
(function() {
  ...
  Keyframe = (function() {
    ...
    persist = function() {
      return this.storage[this.frame][this.actor.id] = state;
    };
  ...
  (function() {
    (function() {
      ...
      Engine = (function() {
        ...
        Engine.prototype.createActor = function(image) {
          patchToBeAnActor(image);
          return this.scene.append(image);
        };

        Engine.prototype.updateOrCreateKeyframe = function(actor, frame) {
          var keyframe;
          keyframe = Keyframe["new"](actor, frame);
        ...
        Engine.prototype.interpolate = function(actor, frame) {
          return Keyframe.interpolateFor(frame, actor);
        };
